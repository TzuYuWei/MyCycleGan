...
model_dir = r'C:\Users\User\Desktop\CycleGAN_FCA_CBAM_ALL\models'
loss_dir = r'C:\Users\User\Desktop\CycleGAN_FCA_CBAM_ALL\loss_plot'
...
class FCACBAM(nn.Module):
    ...
    def forward(self, x):
        fca_out = self.fca(x)
        ca_out = self.ca(x)
        cat = torch.cat([fca_out, ca_out], dim=1)  # (B, 2C, 1, 1)
