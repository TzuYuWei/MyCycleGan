...
with open(r'C:\Users\ericw\Desktop\CycleGAN_CBAM_256(B4)\loss_plot\train_loss_log.csv', "r") as f:
    for line in f:
        if line.strip() == "":
            continue  # 跳過空行
...
plt.grid(True)
plt.tight_layout()
plt.savefig(r"C:\Users\ericw\Desktop\CycleGAN_CBAM_256(B4)\loss_plot\loss_curve.png")
plt.show()
