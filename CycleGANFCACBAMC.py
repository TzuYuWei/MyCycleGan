...
# 你想要儲存的資料夾路徑
TXT_dir = r'C:\Users\ericw\Desktop\CycleGAN_FCA_CBAM_ALL\result\train_mean'
save_dir = r'C:\Users\ericw\Desktop\CycleGAN_FCA_CBAM_ALL\result'
model_dir = r'C:\Users\User\Desktop\CycleGAN_FCA_CBAM_C_ALL\models'
loss_dir = r'C:\Users\User\Desktop\CycleGAN_FCA_CBAM_C_ALL\loss_plot'
...
class FCACBAM(nn.Module):
    def __init__(self, in_planes, ratio=16, kernel_size=7):
        ...
        self.fca = MultiSpectralAttentionLayer(
            in_planes, dct_h=7, dct_w=7, reduction=16, freq_sel_method='top16'
        )
    def forward(self, x):
        fca_out = x*self.fca(x)
        ca_out = fca_out*self.ca(fca_out)
...
def train_cyclegan_unpaired(generator_A2B, generator_B2A, discriminator_A, discriminator_B,
    ...
    for epoch in range(start_epoch, 100):
        for i, (real_A, real_B) in enumerate(dataloader):
            ...
            perceptual_loss = sum([
                criterion_perceptual(r, f) + criterion_perceptual(r, c)
