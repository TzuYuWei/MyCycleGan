...
model_dir = r'C:\Users\User\Desktop\CycleGAN_FCA_CBAM_MLP_ALL\models'
loss_dir = r'C:\Users\User\Desktop\CycleGAN_FCA_CBAM_MLP_ALL\loss_plot'
...
class ResnetBlock(nn.Module):
    ...
    def __init__(self, dim, padding_type='reflect', norm_layer=nn.InstanceNorm2d, use_dropout=False, use_bias=True):
        ...
        self.attention = DynamicFusion(dim)
