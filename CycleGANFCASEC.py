...
model_dir = r'C:\Users\user\Desktop\CycleGAN_FCA_SE_C_ALL\models'
loss_dir = r'C:\Users\user\Desktop\CycleGAN_FCA_SE_C_ALL\loss_plot'
...
class SEFCA(nn.Module):
    ...
    def forward(self, x):
        ...
        se_out = fca_out*self.se(fca_out)
        return se_out
